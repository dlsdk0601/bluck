...
export const MainContentsCardSkeleton = forwardRef<HTMLDivElement, { isFull?: boolean }>(
  (props, ref) => {
    return (
      <div
        ref={ref}
        className={`${loader} relative mb-[20px] flex h-[185px] ${
          props.isFull ? "w-full" : "w-[49%]"
        } items-center justify-center overflow-hidden rounded-xl tablet:h-[175px] tablet:w-[99%] mobile:mx-auto mobile:my-[10px] mobile:block mobile:h-[200px] mobile:w-[90%] mobile:pb-4`}
      >
